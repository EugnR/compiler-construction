...
public class gLexer extends Lexer {
	...
	public static final int
		...
		OCTAL_NUM=41, DECIMAL_NUM=42, HEX_NUM=43, ID=44, NEWLINE=45, WS=46;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "INTEGER", "REAL", "BOOLEAN", "BEGIN", "END", 
			...
			"HEX_NUM", "ID", "NEWLINE", "WS", "DIGIT", "LETTER"
		};
	}
